...
const App: () => React$Node = () => {
  ...
  const [taskLists, setEnteredTaskList] = useState([]);
  ...
  return (
      ...
      <View style={styles.container}>
        ...
        <ToDoForm taskTextHandler={handleTaskFieldChange} taskTextValue={enteredTask} buttonClickHandler={handleTaskList} editButtonClickHandler={handleTaskUpdate} editStatus={editStatus} editTask={editTask} />
